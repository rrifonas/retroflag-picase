...
if [ -e $script ];
	then
		...
		wget "https://github.com/rrifonas/retroflag-picase/raw/master/SafeShutdown-multi.py"
		wget "https://github.com/rrifonas/retroflag-picase/raw/master/multi_switch.sh"
		sudo mv /opt/RetroFlag/SafeShutdown-multi.py SafeShutdown.py 
